...
package xyz.zedler.patrick.grocy.multi.viewmodel;
...
import xyz.zedler.patrick.grocy.multi.Constants.ARGUMENT;
import xyz.zedler.patrick.grocy.multi.Constants.PREF;
import xyz.zedler.patrick.grocy.multi.Constants.SETTINGS.BEHAVIOR;
import xyz.zedler.patrick.grocy.multi.Constants.SETTINGS.STOCK;
import xyz.zedler.patrick.grocy.multi.Constants.SETTINGS_DEFAULT;
import xyz.zedler.patrick.grocy.multi.R;
import xyz.zedler.patrick.grocy.multi.api.GrocyApi;
import xyz.zedler.patrick.grocy.multi.form.FormDataPurchase;
import xyz.zedler.patrick.grocy.multi.fragment.PurchaseFragmentArgs;
import xyz.zedler.patrick.grocy.multi.fragment.bottomSheetDialog.DateBottomSheet;
import xyz.zedler.patrick.grocy.multi.fragment.bottomSheetDialog.InputProductBottomSheet;
import xyz.zedler.patrick.grocy.multi.fragment.bottomSheetDialog.LocationsBottomSheet;
import xyz.zedler.patrick.grocy.multi.fragment.bottomSheetDialog.ProductsBottomSheet;
import xyz.zedler.patrick.grocy.multi.fragment.bottomSheetDialog.QuantityUnitsBottomSheet;
import xyz.zedler.patrick.grocy.multi.fragment.bottomSheetDialog.QuickModeConfirmBottomSheet;
import xyz.zedler.patrick.grocy.multi.fragment.bottomSheetDialog.StoresBottomSheet;
import xyz.zedler.patrick.grocy.multi.helper.DownloadHelper;
import xyz.zedler.patrick.grocy.multi.helper.DownloadHelper.OnJSONArrayResponseListener;
import xyz.zedler.patrick.grocy.multi.helper.DownloadHelper.OnObjectResponseListener;
import xyz.zedler.patrick.grocy.multi.model.Event;
import xyz.zedler.patrick.grocy.multi.model.InfoFullscreen;
...
import xyz.zedler.patrick.grocy.multi.model.ProductDetails;
...
import xyz.zedler.patrick.grocy.multi.model.SnackbarMessage;
import xyz.zedler.patrick.grocy.multi.model.Store;
import xyz.zedler.patrick.grocy.multi.model.StoredPurchase;
import xyz.zedler.patrick.grocy.multi.repository.PurchaseRepository;
import xyz.zedler.patrick.grocy.multi.util.AmountUtil;
import xyz.zedler.patrick.grocy.multi.util.ArrayUtil;
import xyz.zedler.patrick.grocy.multi.util.DateUtil;
import xyz.zedler.patrick.grocy.multi.util.GrocycodeUtil;
import xyz.zedler.patrick.grocy.multi.util.GrocycodeUtil.Grocycode;
import xyz.zedler.patrick.grocy.multi.util.NumUtil;
import xyz.zedler.patrick.grocy.multi.util.PrefsUtil;
import xyz.zedler.patrick.grocy.multi.util.QuantityUnitConversionUtil;
import xyz.zedler.patrick.grocy.multi.util.VersionUtil;
