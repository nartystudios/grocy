...
public class FilterChipLiveDataStatusTasks extends FilterChipLiveData {
  ...
  public FilterChipLiveDataStatusTasks(Application application, Runnable clickListener) {
  ...
  public FilterChipLiveDataStatusTasks setStatus(int status, @Nullable String text) {
  ...
  public FilterChipLiveDataStatusTasks setDueTodayCount(int dueTodayCount) {
    this.dueTodayCount = dueTodayCount;
    return this;
  }

  public FilterChipLiveDataStatusTasks setDueSoonCount(int dueSoonCount) {
    this.dueSoonCount = dueSoonCount;
    return this;
  }

  public FilterChipLiveDataStatusTasks setOverdueCount(int overdueCount) {
