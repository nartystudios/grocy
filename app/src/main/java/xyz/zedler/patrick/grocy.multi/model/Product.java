...
import xyz.zedler.patrick.grocy.multi.database.Converters;
import xyz.zedler.patrick.grocy.multi.helper.DownloadHelper;
import xyz.zedler.patrick.grocy.multi.helper.DownloadHelper.OnMultiTypeErrorListener;
import xyz.zedler.patrick.grocy.multi.helper.DownloadHelper.OnObjectsResponseListener;
import xyz.zedler.patrick.grocy.multi.helper.DownloadHelper.OnStringResponseListener;
import xyz.zedler.patrick.grocy.multi.util.NumUtil;
import xyz.zedler.patrick.grocy.multi.util.VersionUtil;
import xyz.zedler.patrick.grocy.multi.web.NetworkQueue.QueueItem;
import xyz.zedler.patrick.grocy.multi.web.NetworkQueue.QueueItemWithoutLoading;
...
public class Product extends GroupedListItem implements Parcelable {
  ...
  public static QueueItem updateProducts(
    ...
    return updateProducts(dlHelper, dbChangedTime, false, onResponseListener, false);
  }
