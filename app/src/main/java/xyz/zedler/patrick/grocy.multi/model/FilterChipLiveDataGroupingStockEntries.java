...
public class FilterChipLiveDataGroupingStockEntries extends FilterChipLiveData {
  ...
  public FilterChipLiveDataGroupingStockEntries(Application application, Runnable clickListener) {
