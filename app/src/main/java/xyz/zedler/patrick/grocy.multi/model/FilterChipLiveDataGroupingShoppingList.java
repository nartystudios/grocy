...
public class FilterChipLiveDataGroupingShoppingList extends FilterChipLiveData {
  ...
  public FilterChipLiveDataGroupingShoppingList(Application application, Runnable clickListener) {
