...
import xyz.zedler.patrick.grocy.multi.databinding.FragmentSettingsCatNetworkBinding;
...
import xyz.zedler.patrick.grocy.multi.web.RequestQueueSingleton;
...
public class SettingsCatNetworkFragment extends BaseFragment {
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
    ...
    binding.switchLoadingCircle.post(() -> {
      binding.switchLoadingCircle.jumpDrawablesToCurrentState();
      binding.switchTor.jumpDrawablesToCurrentState();
      binding.switchProxy.jumpDrawablesToCurrentState();
    });
